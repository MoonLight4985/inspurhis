...
<div id="wrap">
    <div id="header">
        ...
        <div class="topright">
            <ul>
                <li><span><img src="${pageContext.request.contextPath}/images/index-logout.png" class="helpimg" height="16" width="16"/></span><a href="login.html">注销</a></li>
                <li><span><img src="${pageContext.request.contextPath}/images/t07.png" class="helpimg" height="16" width="16"/></span><a href="userpwdupdate.html">修改密码</a></li>
            </ul>
        </div>
        <div class="clear"></div>
        <div class="subnav">
        ...
        <div class="menu fleft">
            <ul>
                ...
                <ul>
                    ...
                    <li><a href="${pageContext.request.contextPath}/member/list" target="right">会员管理</a></li><!-- 挂号人员独有 -->
