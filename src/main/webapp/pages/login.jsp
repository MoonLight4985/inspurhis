...
<div id="wrap">
    ...
    <div id="content-wrap">
        ...
        <form action="${pageContext.request.contextPath}/login" method="post" name="ThisForm">
            <div class="content">
                <div class="field"><label>账　户：</label><input class="username" name="name"  type="text" value="苍之开"/></div>
                <div class="field"><label>密　码：</label><input class="password" name="password"  type="password" value="12345678"/><br/></div>
                <div class="yzm-box">
                    <!-- <label>验证码：</label>
